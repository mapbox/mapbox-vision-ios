...
private let BytesInKilobyte: Byte = 1024
private let KilobytesInMegabyte: Byte = 1024

private let Kilobyte: Byte = 1 * BytesInKilobyte
private let Megabyte: Byte = Kilobyte * KilobytesInMegabyte

private let SecondsInMinute = 60
private let MinutesInHour = 60
private let Minute = 1 * SecondsInMinute
private let Hour = MinutesInHour * Minute

private let memoryLimit = 300.0 // mb
private let networkingMemoryLimit: Byte = 30 * Megabyte
private let updatingInterval: TimeInterval = TimeInterval(Hour)
...
final class RecordSynchronizer {
    ...
    private let quota = RecordingQuota(memoryQuota: networkingMemoryLimit, updatingInterval: updatingInterval)
...
extension RecordSynchronizer: Synchronizable {
    func sync() {
